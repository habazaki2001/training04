...
<body id="contact" class="under contact_page">
    <div id="wrapper">
        ...
        <main>
            ...
            <div id="content">
                ...
                <div class="inner clearfix">
                    <h3>h3ミーダミーダミーダ<span class="en">DUMMY</span></h3>
                    <section id="fmail_form" class="clearfix">
    ...
    <script>
        if( $('#r_en1669960679').length) {
            document.getElementById("d_en1669960679").colSpan = "2";
        }
    </script>
</body>
